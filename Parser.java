...
public class Parser
{
   ...
   private void removeConstantsandVars()
   {
       ...
       do
       {
           ...
           //replace Constants with their corresponding numbers
    ...
    private void noMultipleNegatives()
   {
    ...
    /****CHANGED THIS PART SO NaN and Infinity ARE DIFFERENT*****/
    private String toString(double number)
   {
	  ...
	  /* if (Double.toString(number).equals("NaN")||Double.toString(number).equals("Infinity"))
	   ...
	   if (Double.toString(number).equals("NaN")){
		   
		   result="NaN"; 
	   }
	   else if(Double.toString(number).equals("Infinity")){
		   result="Infinity";
	   }
	   else if(Double.toString(number).equals("-Infinity")){
		   result="-Infinity";
